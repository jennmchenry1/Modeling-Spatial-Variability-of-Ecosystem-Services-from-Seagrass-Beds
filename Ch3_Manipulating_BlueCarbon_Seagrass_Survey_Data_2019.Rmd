...
df=read.csv("data/Carbon/Seagrass_Survey_Data_QAQC_2019.csv")
head(df)
...
df_wide_species_canopy_height$Mean_Seagrass_Canopy_Height_cm=rowMeans(df_wide_species_canopy_height[c(25:27,29,31:32)])

df_wide_species_canopy_height$Mean_Macroalgae_Canopy_Height_cm=rowMeans(df_wide_species_canopy_height[c(22:24,28,30,33)])

df_wide_species_canopy_height$Thalassia_testudinum_CH=df_wide_species_canopy_height$`Thalassia testudinum`
df_wide_species_canopy_height$Syringodium_filiforme_CH=df_wide_species_canopy_height$`Syringodium filiforme`
df_wide_species_canopy_height$Halodule_wrighti_CH=df_wide_species_canopy_height$`Halodule wrightii`


df_wide_species_cover=join(df_wide_species_cover,df_wide_species_canopy_height[c(1,35:39)],by=c("Reference"))

write.csv(df_wide_species_cover,file="data_output/Seagrass_Species_Cover_QAQC.csv")
...
rs_list_study_region=rs_list_study_region[c(-86)]
...
df_wide_species_cover_environemntal_factors=df_wide_species_cover_environemntal_factors[c(1:4,13,5:12,14:17,19,32,31,25,26:27,29,22:24,28,30,33,34:38,40:41,44:46,50:52,56:58,68:70,74:76,80:82,92:94,98:100,110:112,117:126)]
names(df_wide_species_cover_environemntal_factors)

write.csv(df_wide_species_cover_environemntal_factors,file="data_output/Seagrass_Species_Cover_QAQC_with_Environmental_Factors.csv")
