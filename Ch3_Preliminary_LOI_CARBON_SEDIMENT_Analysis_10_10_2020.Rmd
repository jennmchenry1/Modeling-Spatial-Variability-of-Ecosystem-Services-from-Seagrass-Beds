...
LOI_QAQC=LOI_QAQC%>%
  dplyr::mutate(Slice_Height_Corrected_cm=(Slice_Height_cm*Compaction_Ratio),Slice_Volume=pi*(2.54^2)*Slice_Height_Corrected_cm)%>%
 ...
 dplyr::mutate(Frac_Shell_Carbonate=(Shell_gDW*0.12)/Sample_Weight_gDW,
         Shell_Carbonate_Density_g_per_ml=Frac_Shell_Carbonate*Sample_Density_g_per_ml,
  ...
  dplyr::select(1:12,17:18,22,25:27,29,31:34)
