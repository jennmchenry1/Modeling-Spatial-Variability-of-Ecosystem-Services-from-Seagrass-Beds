...
# BlueCarbon_QAQC=BlueCarbon_QAQC%>%
#   mutate(Dist_To_River=ifelse(Dist_To_River>10,10,Dist_To_River))
...
cont.preds=c("Depth_m","Dist_To_Shore","Dist_To_River","Nitrate.Mean",
             ...
             "Percent_Coarse","Percent_Medium","Percent_Silt","Percent_Sands")

cor(BlueCarbon_QAQC[cont.preds],)
...
```{r}
Seagrass_Clippings_By_Site_QAQC=seagrass_survey_AND_Clippings_By_Site%>%
  ...
  mutate(Thalassia.testudinum.AreaCover=(Thalassia.testudinum/100 *Seagrass_Spp/100)*100,
         Syringodium.filiforme.AreaCover=(Syringodium.filiforme/100 * Seagrass_Spp/100)*100,
         Halodule.wrightii.AreaCover=(Halodule.wrightii/100 * Seagrass_Spp/100)*100)%>%
  mutate(Syringodium_filiforme_gDW=ifelse(Syringodium_filiforme_gDW>4,0.4,Syringodium_filiforme_gDW))

Seagrass_Clippings_By_Site_QAQC[is.na(Seagrass_Clippings_By_Site_QAQC)]<-0


summary(Seagrass_Clippings_By_Site_QAQC)

# Seagrass_Clippings_By_Site_QAQC=Seagrass_Clippings_By_Site_QAQC[complete.cases(Seagrass_Clippings_By_Site_QAQC),]

ggplot(Seagrass_Clippings_By_Site_QAQC,aes(x=Seagrass_Spp)) + geom_histogram(bins=25) + ylab("Number of Sites")+ xlab("Total Seagrass Cover (%)")

ggplot(Seagrass_Clippings_By_Site_QAQC,aes(x=Seagrass_Biomass_gDW)) + geom_histogram(bins=15) + ylab("Number of Sites")+ xlab("Seagrass Biomass (gDW)")


ggplot(Seagrass_Clippings_By_Site_QAQC,aes(y=Seagrass_Biomass_gDW,x=Factor,fill=Factor)) + geom_boxplot()

ggplot(Seagrass_Clippings_By_Site_QAQC,aes(x=Seagrass_Spp,y=Seagrass_Biomass_gDW)) + geom_point()

ggplot(Seagrass_Clippings_By_Site_QAQC,aes(x=Thalassia.testudinum.AreaCover,y=Thalassia_testudinum_gDW)) + geom_point() +geom_smooth(method="lm")

TH_lm=lm(Thalassia_testudinum_gDW~Thalassia.testudinum.AreaCover,data = Seagrass_Clippings_By_Site_QAQC)
summary(TH_lm)

ggplot(Seagrass_Clippings_By_Site_QAQC,aes(x=Syringodium.filiforme.AreaCover,y=Syringodium_filiforme_gDW)) + geom_point()+geom_smooth(method="lm")

SY_lm=lm(Syringodium_filiforme_gDW~Syringodium.filiforme.AreaCover,data = Seagrass_Clippings_By_Site_QAQC)
summary(SY_lm)

ggplot(Seagrass_Clippings_By_Site_QAQC,aes(x=Halodule.wrightii.AreaCover,y=Halodule_wrightii_gDW)) + geom_point() +geom_smooth(method="lm")

HA_lm=lm(Halodule_wrightii_gDW~Halodule.wrightii.AreaCover,data = Seagrass_Clippings_By_Site_QAQC)
summary(HA_lm)


Seagrass_Clippings_By_Site_QAQC%>%
  # mutate(TH_PA=as.factor(TH_PA))%>%
  ggplot(aes(y=Seagrass_Biomass_gDW)) + geom_boxplot()


Seagrass_Clippings_By_Site_QAQC%>%
  # mutate(TH_PA=as.factor(TH_PA))%>%
  ggplot(aes(y=Macro_Algae_Biomass_gDW)) + geom_boxplot()


Seagrass_Clippings_By_Site_QAQC%>%
  # mutate(TH_PA=as.factor(TH_PA))%>%
  ggplot(aes(y=Thalassia_testudinum_gDW)) + geom_boxplot()


Seagrass_Clippings_By_Site_QAQC%>%
  # mutate(TH_PA=as.factor(TH_PA))%>%
  ggplot(aes(y=Syringodium_filiforme_gDW)) + geom_boxplot()


Seagrass_Clippings_By_Site_QAQC%>%
  # mutate(TH_PA=as.factor(TH_PA))%>%
  ggplot(aes(y=Halodule_wrightii_gDW)) + geom_boxplot()


names(Seagrass_Clippings_By_Site_QAQC)


BlueCarbon_QAQC=join(BlueCarbon_QAQC,Seagrass_Clippings_By_Site_QAQC[c(2,20:28)],by="Site")
...
Seagrass_model_Rhiz_6=gam(Rhizome_Stock_g_per_sqm ~ 
                          s(Seagrass_Spp,bs="ts",k=4)+
                          s(Thalassia.testudinum,bs="ts",k=4)+
                         # s(Syringodium.filiforme,bs="ts",k=4)+
                         # s(Halodule.wrightii,bs="ts",k=4)+
...
summary(Seagrass_model_Rhiz_6)


Seagrass_model_Rhiz_7=gam(Rhizome_Stock_g_per_sqm ~ 
                          s(Seagrass_Spp,bs="ts",k=4)+
                          s(Thalassia.testudinum,bs="ts",k=4)+
                         # s(Syringodium.filiforme,bs="ts",k=4)+
                         # s(Halodule.wrightii,bs="ts",k=4)+
...
summary(Seagrass_model_Rhiz_7)


Seagrass_model_Rhiz_8=gam(Rhizome_Stock_g_per_sqm ~ 
                          # s(Seagrass_Spp,bs="ts",k=4)+
                          # s(Thalassia.testudinum,bs="ts",k=4)+
                         # s(Syringodium.filiforme,bs="ts",k=4)+
                         # s(Halodule.wrightii,bs="ts",k=4)+
...
summary(Seagrass_model_Rhiz_8)

gam.check(Seagrass_model_Rhiz_8)
...
plot(Nitrate_Mean_model_Rhiz,trans=exp)
...
full_model_Rhiz=gam(Rhizome_Stock_g_per_sqm~ 
                     ...
                     s(Seagrass_Spp,bs="ts",k=4)+
                      s(Thalassia.testudinum,bs="ts",k=4)+
                     s(Dist_To_Shore,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
...
par(mfrow=c(2,1));
plot.gam(Rhiz_v4,shade=TRUE,shade.col="darkgreen",scheme=2,shift=coef(Rhiz_v4)[1],all.terms=TRUE,rug=TRUE)

AIC(Seagrass_model_Rhiz_8,Rhiz_v4)
...
Seagrass_model_LOI_6=gam(OLOI~ 
                     ...
                     # as.factor(HA_PA),
                   data=BlueCarbon_QAQC, method="ML")
summary(Seagrass_model_LOI_6)
plot.gam(Seagrass_model_LOI_6,shade=TRUE,shade.col="darkgreen",scheme=2,all.terms=TRUE)
...
Sediment_model_LOI=gam(OLOI~ s(Percent_Gravel,bs="ts",k=4)+ s(Percent_Coarse,bs="ts",k=4) +s(Percent_Medium,bs="ts",k=4)+s(Percent_Fine,bs="ts",k=4) +s(Percent_Silt,bs="ts",k=4) + s(Percent_Sands,bs="ts",k=5), data=BlueCarbon_QAQC,method="ML")
...
AIC(Seagrass_model_LOI_6,LOI_v3)
...
```{r}
Seagrass_model_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm)~ 
                         s(Seagrass_Spp,bs="ts",k=4)+
                          s(Thalassia.testudinum,k=4)+
                          s(Syringodium.filiforme,k=4)+
                          s(Halodule.wrightii,k=4)+
                         s(Rhizome_Stock_g_per_sqm,bs="ts",k=4)+
                         as.factor(Factor)+
                         as.factor(TH_PA)+ 
                         as.factor(SY_PA)+ 
...
Seagrass_model_OCD_2=gam(log(Organic_Carbon_Stock_g_per_sqm)~ 
                         s(Seagrass_Spp,bs="ts",k=4)+
                          s(Thalassia.testudinum,k=4)+
                          # s(Syringodium.filiforme,k=4)+
                          s(Halodule.wrightii,k=4)+
...
Seagrass_model_OCD_3=gam(log(Organic_Carbon_Stock_g_per_sqm)~ 
                         s(Seagrass_Spp,bs="ts",k=4)+
                          s(Thalassia.testudinum,k=4)+
                          # s(Syringodium.filiforme,k=4)+
                          s(Halodule.wrightii,k=4)+
...
Seagrass_model_OCD_4=gam(log(Organic_Carbon_Stock_g_per_sqm)~ 
                         # s(Seagrass_Spp,bs="ts",k=4)+
                          s(Thalassia.testudinum,k=4)+
                          # s(Syringodium.filiforme,k=4)+
                          s(Halodule.wrightii,k=4)+
...
Seagrass_model_OCD_5=gam(log(Organic_Carbon_Stock_g_per_sqm)~ 
                         # s(Seagrass_Spp,bs="ts",k=4)+
                          # s(Thalassia.testudinum,k=4)+
                          # s(Syringodium.filiforme,k=4)+
                          s(Halodule.wrightii,k=4)+
...
Seagrass_model_OCD_6=gam(log(Organic_Carbon_Stock_g_per_sqm)~ 
                         # s(Seagrass_Spp,bs="ts",k=4)+
                          # s(Thalassia.testudinum,k=4)+
                          # s(Syringodium.filiforme,k=4)+
                          s(Halodule.wrightii,k=4)+
...
Seagrass_model_OCD_7=gam(log(Organic_Carbon_Stock_g_per_sqm)~ 
                         # s(Seagrass_Spp,bs="ts",k=4)+
                          # s(Thalassia.testudinum,k=4)+
                          # s(Syringodium.filiforme,k=4)+
                          s(Halodule.wrightii,k=4)+
...
plot.gam(Seagrass_model_OCD_7,shade=TRUE,shade.col="darkgreen",scheme=2,shift=coef(Seagrass_model_OCD_7)[1],all.terms=TRUE)
...
# Secchi_model_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm)~ s(Secchi_m,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
...
Sediment_model_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm)~ s(Percent_Gravel,bs="ts",k=4)+ s(Percent_Coarse,bs="ts",k=4) +s(Percent_Medium,bs="ts",k=4)+s(Percent_Fine,bs="ts",k=4) +s(Percent_Silt,bs="ts",k=4) +s(Percent_Sands,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
summary(Sediment_model_OCD)

Nitrate_Mean_model_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm)~ s(Nitrate.Mean,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
summary(Nitrate_Mean_model_OCD)
plot(Nitrate_Mean_model_OCD,trans=exp)

Par_Mean_model_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm)~ s(Par.Mean,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
...
Dist_from_River_Shore_model_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm) ~ s(Dist_To_River,by=Factor,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
summary(Dist_from_River_Shore_model_OCD)

Treatment_Mean_model_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm)~ Factor + s(Halodule.wrightii,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
summary(Treatment_Mean_model_OCD)

# Rhizomes_model_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm) ~ s(Rhizome_Stock_g_per_sqm,bs="ts",k=4) + Factor + HA_PA, data=BlueCarbon_QAQC,method="ML")
...
full_model_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm) ~ 
                     s(Par.Mean,bs="ts",k=4)+
                     s(Dist_To_River,bs="ts",k=4) +
                     s(Dist_To_River,by=Factor,bs="ts",k=4) +
                     s(Percent_Silt,bs="ts",k=4) + 
...
v1_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm) ~ 
                     s(Par.Mean,bs="ts",k=4)+
                     s(Dist_To_River,bs="ts",k=4) +
                     # s(Dist_To_River,by=Factor,bs="ts",k=4) +
                     s(Percent_Silt,bs="ts",k=4) + 
...
v2_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm) ~ 
                     # s(Par.Mean,bs="ts",k=4)+
                     s(Dist_To_River,bs="ts",k=4) +
                     # s(Dist_To_River,by=Factor,bs="ts",k=4) +
                     s(Percent_Silt,bs="ts",k=4) + 
...
v3_OCD=gam(log(Organic_Carbon_Stock_g_per_sqm) ~ 
                     # s(Par.Mean,bs="ts",k=4)+
                     # s(Dist_To_River,bs="ts",k=4) +
                     # s(Dist_To_River,by=Factor,bs="ts",k=4) +
                     s(Percent_Silt,bs="ts",k=4) + 
...
AIC(Seagrass_model_OCD_7,v3_OCD,v2_OCD,v1_OCD)

par(mfrow=c(2,2));
plot.gam(v3_OCD,shade=TRUE,shade.col="darkgreen",shift=coef(v3_OCD)[1],scheme=2,all.terms=TRUE)
...
#GAM Carbonate Stock
```{r}
Seagrass_model_In=gam(log(Inorganic_Carbon_Stock_g_per_sqm)~ 
                         s(Seagrass_Spp,bs="ts",k=4)+
                          s(Thalassia.testudinum.AreaCover,k=4)+
                          s(Syringodium.filiforme.AreaCover,k=4)+
                          s(Halodule.wrightii.AreaCover,k=4)+
...
plot.gam(Seagrass_model_In,shade=TRUE,shade.col="darkgreen",scheme=2,shift=coef(Seagrass_model_TOT)[1],all.terms=TRUE)

Seagrass_model_In_2=gam(log(Inorganic_Carbon_Stock_g_per_sqm)~ 
                         s(Seagrass_Spp,bs="ts",k=4)+
                            s(Thalassia.testudinum.AreaCover,k=4)+
                          s(Syringodium.filiforme.AreaCover,k=4)+
                          s(Halodule.wrightii.AreaCover,k=4)+
...
Seagrass_model_In_3=gam(log(Inorganic_Carbon_Stock_g_per_sqm)~ 
                         s(Seagrass_Spp,bs="ts",k=4)+
                            s(Thalassia.testudinum.AreaCover,k=4)+
                          s(Syringodium.filiforme.AreaCover,k=4)+
                          s(Halodule.wrightii.AreaCover,k=4)+
...
Seagrass_model_In_4=gam(log(Inorganic_Carbon_Stock_g_per_sqm)~ 
                         s(Seagrass_Spp,bs="ts",k=4)+
                            s(Thalassia.testudinum.AreaCover,k=4)+
                          # s(Syringodium.filiforme.AreaCover,k=4)+
                          s(Halodule.wrightii.AreaCover,k=4)+
...
Seagrass_model_In_5=gam(log(Inorganic_Carbon_Stock_g_per_sqm)~ 
                         s(Seagrass_Spp,bs="ts",k=4)+
                            s(Thalassia.testudinum.AreaCover,k=4)+
                          # s(Syringodium.filiforme.AreaCover,k=4)+
                          s(Halodule.wrightii.AreaCover,k=4)+
...
Seagrass_model_In_6=gam(log(Inorganic_Carbon_Stock_g_per_sqm)~ 
                         # s(Seagrass_Spp,bs="ts",k=4)+
                            s(Thalassia.testudinum.AreaCover,k=4)+
                          # s(Syringodium.filiforme.AreaCover,k=4)+
                          s(Halodule.wrightii.AreaCover,k=4)+
...
Seagrass_model_In_7=gam(log(Inorganic_Carbon_Stock_g_per_sqm)~ 
                         # s(Seagrass_Spp,bs="ts",k=4)+
                            s(Thalassia.testudinum.AreaCover,k=4)+
                          # s(Syringodium.filiforme.AreaCover,k=4)+
                          s(Halodule.wrightii.AreaCover,k=4),
...
summary(Seagrass_model_In_7)

Seagrass_model_In_8=gam((Inorganic_Carbon_Stock_g_per_sqm)~ 
                         # s(Seagrass_Spp,bs="ts",k=4)+
                            # s(Thalassia.testudinum.AreaCover,k=4)+
                          # s(Syringodium.filiforme.AreaCover,k=4)+
                          # s(Halodule.wrightii.AreaCover,k=4)+
...
plot.gam(Seagrass_model_In_8,shade=TRUE,shade.col="darkgreen",scheme=2,shift=coef(Seagrass_model_In_8)[1],trans=exp,all.terms=TRUE)

gam.check(Seagrass_model_OCD_8)

# Secchi_model_In=gam(log(Inorganic_Carbon_Stock_g_per_sqm)~ s(Secchi_m,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
# summary(Secchi_model_TOT)
...
# Sand_model_In=gam(log(Inorganic_Carbon_Stock_g_per_sqm)~  s(Percent_Coarse,bs="ts",k=4) +s(Percent_Medium,bs="ts",k=4)+s(Percent_Fine,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
# summary(Sand_model_In)

Sediment_model_In=gam((Inorganic_Carbon_Stock_g_per_sqm)~ s(Percent_Gravel,bs="ts",k=4)+ s(Percent_Coarse,bs="ts",k=4) +s(Percent_Medium,bs="ts",k=4)+s(Percent_Fine,bs="ts",k=4) +s(Percent_Silt,bs="ts",k=4) +s(Percent_Sands,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
...
full_model_In=gam((Inorganic_Carbon_Stock_g_per_sqm) ~ 
                     ...
                     s(Dist_To_River, by=Factor,bs="ts",k=4)+
                     as.factor(TH_PA) +
                     as.factor(Factor), data=BlueCarbon_QAQC,method="ML")
...
AIC(Seagrass_model_OCD_8,v3_In)

par(mfrow=c(2,3));
plot.gam(v3_In,shade=TRUE,shade.col="darkgreen",shift=coef(v3_In)[1],scheme=2,all.terms=TRUE)
...
cont.preds=c("Depth_m","Dist_To_Shore","Dist_To_River","Nitrate.Mean",
             "Rhizome_Stock_g_per_sqm",
             "Thalassia.testudinum", "Syringodium.filiforme",
             "Halodule.wrightii","Seagrass_Spp","Percent_Sands",
             "Percent_Coarse","Percent_Medium","Percent_Silt")
...
all.less.2AICc=OC_ModelTable[which(OC_ModelTable$delta.AICc<2),]
all.less.2AICc$formula
...
#final models
final_model_OC=mgcv::gam(Organic_Carbon_Stock_g_per_sqm ~ Factor+ s(Percent_Silt,by=HA_PA,bs="ts",k=4) +HA_PA,data=BlueCarbon_QAQC, method="ML")

summary(final_model_OC)

plot(final_model_OC,shade=TRUE,shade.col="darkgreen",scheme=2,all.terms=TRUE)


final_model_OC_v2=mgcv::gam(Organic_Carbon_Stock_g_per_sqm ~ te(Percent_Coarse,Percent_Medium,bs="ts",k=4)+s(Percent_Silt,bs="ts",k=4)+ +s(Rhizome_Stock_g_per_sqm,bs="ts",k=4),data=BlueCarbon_QAQC, method="ML")

summary(final_model_OC_v2)


plot(final_model_OC_v2,shade=TRUE,shade.col="darkgreen",scheme=2,all.terms=TRUE)
