...
ggplot(Seagrass_Clippings_By_Site_QAQC,aes(x=Seagrass_Spp,y=Seagrass_Biomass_gDW)) + geom_point()+geom_smooth(method="gam")

ggplot(Seagrass_Clippings_By_Site_QAQC,aes(x=Thalassia.testudinum.AreaCover,y=Thalassia_testudinum_gDW)) + geom_point() +geom_smooth(method="gam")

TH_lm=lm(Thalassia_testudinum_gDW~Thalassia.testudinum.AreaCover,data = Seagrass_Clippings_By_Site_QAQC)
summary(TH_lm)

ggplot(Seagrass_Clippings_By_Site_QAQC,aes(x=Syringodium.filiforme.AreaCover,y=Syringodium_filiforme_gDW)) + geom_point()+geom_smooth(method="gam")

SY_lm=lm(Syringodium_filiforme_gDW~Syringodium.filiforme.AreaCover,data = Seagrass_Clippings_By_Site_QAQC)
summary(SY_lm)

ggplot(Seagrass_Clippings_By_Site_QAQC,aes(x=Halodule.wrightii.AreaCover,y=Halodule_wrightii_gDW)) + geom_point() +geom_smooth(method="gam")
