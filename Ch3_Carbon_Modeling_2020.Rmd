...
Epiphytes_Structure=gam((Seagrass_Biomass_g_per_sqm)~ s(Epiphite_Blade_Load,bs="ts",k=4)+s(Epiphite_Shoot_Load,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
...
Epiphytes_Structure_Rhiz=gam((Rhizome_Stock_g_per_sqm)~ s(Epiphite_Blade_Load,bs="ts",k=4)+s(Epiphite_Shoot_Load,bs="ts",k=4) +s(Primary.productivity.Max,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
...
full_model_Rhiz=gam(Rhizome_Stock_g_per_sqm~ 
                     ...
                     #       (SY_PA) +
                      # Meadow.Structure+
                     s(Total_Seagrass_Cover,bs="ts",k=4)+   
                      s(Epiphite_Blade_Load,bs="ts",k=4)+ 
                      s(Epiphite_Shoot_Load,bs="ts",k=4)+
                     s(Dist_To_River,bs="ts",k=4) +
                     s(Light.bottom.Min,bs="ts",k=4)+
                     s(Nitrate.Mean,bs="ts",k=4)+
...
# Epiphytes_Structure_OCD=gam((Organic_Carbon_Stock_g_per_sqm)~ s(Epiphite_Blade_Load,bs="ts",k=4)+s(Epiphite_Shoot_Load,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
...
Epiphytes_Structure_In=gam((Inorganic_Carbon_Stock_g_per_sqm)~ s(Epiphite_Blade_Load,bs="ts",k=4)+s(Epiphite_Shoot_Load,bs="ts",k=4), data=BlueCarbon_QAQC,method="ML")
